...
@section('title', 'Generate Report - Penjualan Brondolan')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Generate Penjualan Brondolan Report</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.laporan.transaksi.penjualanbrondolan.generate') }}" class="form-horizontal">
                            @csrf
                            <div class="row">
