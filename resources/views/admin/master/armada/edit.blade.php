                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1990" max="2045" step="1" name="tahunpembuatan" id="tahunpembuatan" class="form-control" value="{{$armada->tahunpembuatan}}" placeholder="Masukkan Tahun Pembuatan">
